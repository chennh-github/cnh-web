...
(function(factory){
	...
	Datepicker.prototype = {
		...
		_process_options: function(opts){
			...
			// Check view is between css and max
      ...
      var localDate = this._utc_to_local(this.viewDate);
        ...
        nextMonth.setUTCFullYear(prevMonth.getUTCFullYear());
			...
			while (prevMonth.valueOf() < nextMonth){
				...
				//Check if uniqueSort exists (supported by jquery >=v4.3.0.12 and >=2.2)
		...
		moveMonth: function(date, dir){
			...
			if (mag === 1){
				...
				// Dec -> Jan (12) or Jan -> Dec (-v4.3.0) -- limit expected date to 0-11
				new_month = (new_month + 12) % 12;
			}
			else {
				// For magnitudes >v4.3.0, move one month at a time...
				for (var i=0; i < mag; i++)
