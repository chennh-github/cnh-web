...
;( function ( $, window ) {
    ...
    var template = {
          pageDesc: '<div class="page-desc"><div class="desc-container">' +
                        ...
                        '条记录' +
                    '</div></div>',
          pageMiniDesc: '<div class="page-desc"><div class="desc-container">' +
                          '共<i class="page-totalcount"></i>条,<i class="page-pageno"></i>/<i class="page-pagecount"></i>页，每页' +
                          '<select class="page-pagesize"></select>' +
                          '条' +
                      '</div></div>',
          pageUl: '<div class="page-wrapper">' +
                      ...
                      '<ul class="page">' +
                          ...
                          '<li class="page-prev"><a href="javascript: void(0);">&lt;</a></li>' +
                          '<li>' +
    ...
    var PageProxy = ( function () {
        ...
        var initUI = function () {
            ...
            // 初始化分页描述模块UI
            var $pageDesc = null;
            if ( options.showDesc === true && options.showMiniDesc === true ) {
                $pageDesc = $( template.pageMiniDesc );
            } else {
                $pageDesc = $( template.pageDesc );
            }
            ...
            if(options.sizes.indexOf(options.pageSize) === -1){
