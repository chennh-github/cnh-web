<ul class="side-nav-top nav">
    <li class="sidebar-nav-logo">
        <img src="<@path path='static/images/system/sidebar-logo.png' />" alt="Dee Admin">
    ...
    <li class="sidebar-nav-profile">
        <div class="profile-left">
            <img src="<@path path='static/images/system/user.jpg' />" alt="Peter Boussa">
        </div>
        <div class="profile-right">
                    <span class="name">
                        Peter Boussa<i id="user-profile-settings-toggler" class="fa fa-caret-down l-pad-5"></i>
                    </span>
                    <span class="info">
                        Project Manager
                    </span>
