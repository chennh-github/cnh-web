...
public class HttpRequestWrap {
    ...
    public static void setContentType(String contentType) {
        HttpRequestWrap.contentType = contentType;
    }
    ...
    public static String get(String getUrl) throws IOException {
        return HttpRequestWrap.httpGet(getUrl, false);
    }
    ...
    public static String get(String getUrl, String proxyIp, int proxyPort) throws IOException {
        HttpRequestWrap.setProxy(proxyIp, proxyPort);
        return HttpRequestWrap.httpGet(getUrl, true);
    }
    ...
    public static String get(String getUrl, String params) throws IOException {
        return HttpRequestWrap.httpGet(getUrl + "?" + params, false);
    }
    ...
    public static String get(String getUrl, String params, String proxyIp, int proxyPort) throws IOException {
        HttpRequestWrap.setProxy(proxyIp, proxyPort);
        return HttpRequestWrap.httpGet(getUrl + "?" + params, true);
    }
    ...
    public static String post(String postUrl, String params) throws IOException {
        return HttpRequestWrap.httpPost(postUrl, params, false);
    }
    ...
    public static String post(String postUrl, String params, String proxyIp, int proxyPort) throws IOException {
        HttpRequestWrap.setProxy(proxyIp, proxyPort);
        return HttpRequestWrap.httpPost(postUrl, params, true);
    }
    ...
    public static String postChunk(String postUrl, String params) throws IOException {
        return HttpRequestWrap.httpChunkPost(postUrl, params, false);
    }
    ...
    public static String postChunk(String postUrl, String params, String proxyIp, int proxyPort) throws IOException {
        HttpRequestWrap.setProxy(proxyIp, proxyPort);
        return HttpRequestWrap.httpChunkPost(postUrl, params, true);
    }
    ...
    public static boolean isAsynRequest(HttpServletRequest request) {
        ...
        boolean isAsynRequest = "XMLHttpRequest".equals(header) ? true : false;
...
//		getUrl = URLEncoder.encode(getUrl);
        ...
        if (useProxy) {
            connection = (HttpURLConnection) httpUrl.openConnection(HttpRequestWrap.useProxy(httpUrl));
        } else {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(
                connection.getInputStream(), HttpRequestWrap.encoding));
        String lines;
    ...
    private static String httpPost(String postUrl, String params, boolean useProxy)
        ...
        connection.setRequestProperty("Content-Type",
                HttpRequestWrap.contentType);
        // 连接，从postUrl.openConnection()至此的配置必须要在connect之前完成，
        // 要注意的是connection.getOutputStream会隐含的进行connect。
        connection.connect();
        OutputStreamWriter out = new OutputStreamWriter(
                connection.getOutputStream(), HttpRequestWrap.encoding);
    ...
    private static void setProxy(String proxyIp, int proxyPort) {
        HttpRequestWrap.proxyIp = proxyIp;
        HttpRequestWrap.proxyPort = proxyPort;
    }
    ...
    private static Proxy useProxy(URL httpUrl) throws IOException {
        ...
        InetSocketAddress socketAddress = new InetSocketAddress(
                InetAddress.getByName(HttpRequestWrap.proxyIp),
                HttpRequestWrap.proxyPort);
