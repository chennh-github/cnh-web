...
public class FileWrap {
    ...
    public static boolean isFile(String filePath) {
        boolean b = FileWrap.isExist(filePath) && (new File(filePath)).isFile();
    ...
    public static boolean isDirectory(String dirPath) {
        boolean b = FileWrap.isExist(dirPath) && (new File(dirPath)).isDirectory();
    ...
    public static boolean deleteFileOrDirectory(String path) {
        boolean b = FileWrap.isExist(path);
        if (b) {
     ...
     * @throws IOException
     */
    public static void writeToFile(final String filePath, final String text, String encoding) throws IOException {
     ...
     * @throws IOException
     */
    public static void writeToFile(final String filePath, final String text) throws IOException {
        writeToFile(filePath, text, "UTF-8");
    }
